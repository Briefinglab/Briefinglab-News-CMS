 ...
 */
require_once plugin_dir_path(__FILE__) . 'includes/class-bl-slider-cms-manager.php';

/**
 * Instantiates the Manager class and then
 * calls its run method officially starting up the plugin.
 */
function run_bl_slider_cms_manager()
{
    $bl_slider = new Bl_News_Cms_Manager();
    $bl_slider->run();
}

// Call the above function to begin execution of the plugin.
run_bl_slider_cms_manager();
